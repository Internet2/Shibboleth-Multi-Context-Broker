...
/**
 * Handle the actual authentication of the end user based on the MCB
 * configuration.
 *
 * @author Paul Hethmon
 *
...
public class MCBLoginServlet extends HttpServlet {
    ...
    /**
     * Process the user's selection for authentication methods and send control
     * to the proper submodule.
     *
     * @param request
     * @param response
    ...
    /**
     * Based on configuration, either show the list of methods for the user to
     * choose from or display the login for that method if there is only one, or
     * only one by configuration.
     *
     * @param request
     * @param response
     */
    ...
    /**
     * This version of showMethods is used after a user has done an initial
     * authentication and has been identified.
     *
     * @param request
     * @param response
     * @param potentialContexts The list of context values the idms has listed
     * for the user.
    ...
    /**
     * Helper method for submodules to display a login form using Velocity
     * templates.
     *
    ...
    /**
     * Validate that the method returned by the selection page (from the end
     * user) is actually permitted to be selected.
     *
     * @param selectedMethod The method as selected by the user on the selection
     * page.
